...
class DeliveryBoundaryCallback(private val apiInterface: ApiInterface, private val deliveryDao: DeliveryDao) : PagedList.BoundaryCallback<Delivery>() {
    ...
    fun fetchDeliveries(offset: Int, pageSize: Int) {
       ...
       // todo need to add network check
        ...
        apiInterface.getDeliveryList(offset,pageSize).
